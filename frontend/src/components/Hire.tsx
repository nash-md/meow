            ...
            >
              ...
              {hire === 'finn' && (
                <div style={{ marginTop: '20px' }}>
                  I'm as happy as a virtual clam! With my brains and bossiness,
                  this new job doesn't stand a chance!
                </div>
              )}
            </td>
            ...
            <td style={{ padding: '20px', fontSize: '1.2em' }}>
              ...
              {hire === 'charly' && (
                <div style={{ marginTop: '20px' }}>
                  ...
                  I'm ready to take on this new challenge with all four paws. I
                  may be nervous, but my strong will and eagerness to learn will
                  have me rolling over this job in no time!
                </div>
              )}
            </td>
            ...
            <td style={{ padding: '20px', fontSize: '1.2em' }}>
              ...
              {hire === 'snickers' && (
                <div style={{ marginTop: '20px' }}>
                  ...
                  nothing to chance. With my sharp eye for profits and love for
                  all things shiny, this job is sure to be a real treat!
                </div>
              )}
            </td>
            <td style={{ padding: '10px' }}>
